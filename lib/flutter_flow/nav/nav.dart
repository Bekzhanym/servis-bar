...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CardOfProductWidget.routeName,
          path: CardOfProductWidget.routePath,
          asyncParams: {
            'aboutproduct': getDoc(['goods'], GoodsRecord.fromSnapshot),
          },
          builder: (context, params) => CardOfProductWidget(
            aboutproduct: params.getParam(
              'aboutproduct',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: MyLocationsWidget.routeName,
          path: MyLocationsWidget.routePath,
          builder: (context, params) => MyLocationsWidget(),
        ),
        FFRoute(
          name: BasketWidget.routeName,
          path: BasketWidget.routePath,
          builder: (context, params) => BasketWidget(),
        ),
        FFRoute(
          name: DostavkaWidget.routeName,
          path: DostavkaWidget.routePath,
          builder: (context, params) => DostavkaWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: YourOrderWidget.routeName,
          path: YourOrderWidget.routePath,
          builder: (context, params) => YourOrderWidget(),
        ),
        FFRoute(
