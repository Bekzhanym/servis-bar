...
class _AboutMeWidgetState extends State<AboutMeWidget> {
  ...
  void initState() {
    ...
    _model.textController4 ??=
        TextEditingController(text: currentUserDocument?.birthday?.toString());
                  ...
                  child: Row(
                    ...
                    children: [
                      FlutterFlowRadioButton(
                        options: ['Мужской', 'Женский'].toList(),
                        onChanged: (val) => safeSetState(() {}),
                        controller: _model.radioButtonValueController ??=
                            FormFieldController<String>('Женский'),
                        optionHeight: 32.0,
                        textStyle:
                        ...
                        inactiveRadioButtonColor: Color(0xFFE8E9EB),
                        toggleable: false,
